...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-03-2017 a las 16:11:52
...
INSERT INTO `especialidad` (`id`, `car_id`, `nombre`) VALUES
(1, 1, 'Mecanico');
...
--
-- Volcado de datos para la tabla `especialidad_cargo`
--

INSERT INTO `especialidad_cargo` (`id`, `are_id`, `nombre`) VALUES
(1, 1, 'Mecanico');
...
CREATE TABLE `evaluacion_alternativa` (
  ...
  `altenativa` text COLLATE utf8_spanish_ci NOT NULL COMMENT 'Posibles Respuesta',
  `poderacion` float NOT NULL DEFAULT '1',
  `correcta` enum('SI','NO') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'NO'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `evaluacion_alternativa`
--

INSERT INTO `evaluacion_alternativa` (`id`, `pre_id`, `altenativa`, `poderacion`, `correcta`) VALUES
(1, 1, 'Relación 2:1. Ha aumentado su velocidad y perdido su fuerza de trabajo.', 1, 'NO'),
(2, 1, 'Relación 1:2. Ha perdido velocidad y aumentado la fuerza de trabajo.', 1, 'NO'),
(3, 1, 'Relación 2:1. Ha perdido velocidad y aumentado la fuerza de trabajo.', 1, 'SI'),
(4, 1, 'Relación 1:2. Ha aumentado su velocidad y perdido su fuerza de trabajo.', 1, 'NO'),
(5, 1, 'Ninguna de las anteriores.', 1, 'NO'),
(6, 2, 'Alternativa 1', 1, 'NO'),
(7, 2, 'Alternativa 2', 1, 'SI'),
(8, 3, 'Alternativa 3', 1, 'NO'),
(9, 3, 'Alternativa 3 Correcta', 1, 'SI');
...
CREATE TABLE `evaluacion_pregunta` (
  `id` int(10) UNSIGNED NOT NULL,
  `eva_id` mediumint(8) UNSIGNED NOT NULL,
...
INSERT INTO `evaluacion_pregunta` (`id`, `eva_id`, `pregunta`, `comentario`, `creado`, `modificado`, `habilitado`) VALUES
(1, 3, 'Según el ejemplo, el engranaje motriz gira a 100 R.P.M. y, debido a su\r\nrelación, el engranaje conducido gira a sólo 50 R.P.M.\r\n¿Cuál es la relación de transmisión y en que afecta su trabajo?', 'Seleccione la alternativa correcta:', '2017-03-28 15:33:52', NULL, 'SI'),
(2, 3, 'Según,  la identificación de los grados de dureza del perno podemos determinar el torque, entonces un perno SAE 8,8 es :', NULL, '2017-03-28 15:54:05', NULL, 'SI'),
(3, 3, 'Video Prueba', NULL, '2017-03-28 15:54:05', NULL, 'SI'),
(4, 3, 'Sonido Prueba', NULL, '2017-03-28 15:54:05', NULL, 'SI');
...
--
-- Volcado de datos para la tabla `evaluacion_teorica`
--

INSERT INTO `evaluacion_teorica` (`id`, `tev_id`, `nombre`, `descripcion`) VALUES
(3, 1, 'Uso de Herramientas', NULL),
(4, 1, 'Metrología y Uso de Equipos de Medición', NULL);
...
INSERT INTO `evaluacion_tipo` (`id`, `nombre`, `descripcion`) VALUES
(1, 'Mecanica', NULL);
...
CREATE TABLE `ficha_practica` (
  `id` bigint(20) UNSIGNED NOT NULL COMMENT 'Nota de Ficha Practica',
  `mod_id` mediumint(8) UNSIGNED NOT NULL COMMENT 'Modulo',
  `fic_id` int(10) UNSIGNED NOT NULL COMMENT 'Ficha de evaluación',
  `eva_id` smallint(6) DEFAULT NULL COMMENT 'Evaluador',
  `nota` decimal(2,1) NOT NULL COMMENT 'Nota de 0 - 1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `ficha_respuesta` (
  ...
  `fict_id` int(10) UNSIGNED NOT NULL COMMENT 'Ficha Teorica',
...
INSERT INTO `orden_trabajo` (`id`, `emp_id`, `esp_id`, `per_id`, `sol_id`, `inicio`, `termino`, `direccion`, `estado`) VALUES
(1, 1, 1, 1, 1, '2017-03-01', '2017-03-31', 'Dalcahue 12', 'EXTENCION');
...
--
-- Volcado de datos para la tabla `orden_trabajo_solicitud`
--

INSERT INTO `orden_trabajo_solicitud` (`id`, `emp_id`, `usu_id`, `creacion`, `inicio`, `termino`) VALUES
(1, 1, 1, '2017-03-29', '2017-03-29', '2017-05-29');
...
--
-- Volcado de datos para la tabla `orden_trabajo_trabajador`
--

INSERT INTO `orden_trabajo_trabajador` (`id`, `ot_id`, `tra_id`) VALUES
(1, 1, 1);
...
INSERT INTO `perfil` (`id`, `nombre`, `descripcion`, `documento`) VALUES
(1, 'Mecánica Industrial,Tecnica A', '', NULL);
...
--
-- Volcado de datos para la tabla `perfil_evaluacion_teorica`
--

INSERT INTO `perfil_evaluacion_teorica` (`id`, `evt_id`, `mop_id`) VALUES
(1, 3, 1),
(2, 4, 4);
...
CREATE TABLE `perfil_modulo` (
  ...
  `nombre` varchar(256) COLLATE utf8_spanish_ci NOT NULL,
  `nivel` enum('PRIMARIO','SECUNDARIO','IGNORAR') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'SECUNDARIO',
  `evaluacion` set('TEORICA','PRACTICA','TERCERO') COLLATE utf8_spanish_ci NOT NULL COMMENT 'Evaluacion',
  `ponderacion` float NOT NULL DEFAULT '1' COMMENT 'Ponderación de Nota Final'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `perfil_modulo` (`id`, `per_id`, `nombre`, `nivel`, `evaluacion`, `ponderacion`) VALUES
(1, 1, 'Uso de Herramientas', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(4, 1, 'Metodología y Uso de Equipos de Medición', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(5, 1, 'Transmisión por Caja Reductora', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(6, 1, 'Transmisión por Correas', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(7, 1, 'Acoplamientos Mecánicos', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(8, 1, 'Rodamientos, tipos y montajes.', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(9, 1, 'Contacto con Fluidos y Válvulas Manuales', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(10, 1, 'Interpretación de Planos', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(11, 1, 'Alineamiento de equipos', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(12, 1, 'Maniobras de Izaje', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(13, 1, 'Conocimiento en Bombas', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(14, 1, 'Conocimiento en Ventiladores', 'SECUNDARIO', 'TEORICA,PRACTICA', 1),
(15, 1, 'Psicologico', 'PRIMARIO', 'TERCERO', 1),
(16, 1, 'Seguridad', 'PRIMARIO', 'TERCERO', 1),
(17, 1, 'Usuario', 'PRIMARIO', 'TERCERO', 1),
(19, 1, 'Curriculum', 'PRIMARIO', 'TERCERO', 1);
...
INSERT INTO `recursos` (`id`, `pre_id`, `tipo`) VALUES
(1, 1, 'IMAGE'),
(2, 2, 'IMAGE'),
(3, 3, 'VIDEO'),
(4, 4, 'VIDEO');
...
--
-- Volcado de datos para la tabla `recursos_has_options`
--

INSERT INTO `recursos_has_options` (`id`, `rec_id`, `opt_id`) VALUES
(1, 3, 1),
(2, 3, 2),
(3, 3, 3),
(4, 3, 4);
...
--
-- Volcado de datos para la tabla `recursos_has_sources`
--

INSERT INTO `recursos_has_sources` (`id`, `rec_id`, `src_id`) VALUES
(1, 1, 1),
(2, 2, 2),
(3, 3, 3),
(5, 4, 1),
...
CREATE TABLE `recursos_options` (
  ...
  `tipo` enum('STRING','INTEGER','FLOAT','BOOL','JSON') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'STRING'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `recursos_options`
--

INSERT INTO `recursos_options` (`id`, `variable`, `valor`, `tipo`) VALUES
(1, 'loop', 'true', 'BOOL'),
(2, 'autoplay', 'true', 'BOOL'),
(3, 'controls', 'true', 'BOOL'),
(4, 'preload', 'auto', 'STRING');
...
--
-- Volcado de datos para la tabla `recursos_sources`
--

INSERT INTO `recursos_sources` (`id`, `src`, `type`, `title`) VALUES
(1, 'src/image/1.JPG', 'image/jpeg', NULL),
(2, 'src/image/2.JPG', 'image/jpeg', NULL),
(3, 'src/video/Luis Fonsi[1080].mp4', 'video/mp4', NULL),
(4, 'src/audio/Shakira[high].mp3', 'audio/mpeg', NULL);
...
(4, 'Ruben Eduardo Tejeda Roa', '1992-04-12', 0, 'SOLTERO/A', 'A1,B', '1.70', NULL),
(20, 'Alexis', '1992-01-15', 0, 'SOLTERO/A', 'B', '1.80', NULL);
...
CREATE TABLE `trabajador` (
  ...
  `com_id` smallint(5) UNSIGNED DEFAULT NULL COMMENT 'Comuna',
  `pais_id` tinyint(3) UNSIGNED DEFAULT '46' COMMENT 'Nacionalidad',
  `rut` varchar(12) COLLATE utf8_spanish_ci NOT NULL COMMENT 'RUT',
...
INSERT INTO `trabajador` (`id`, `com_id`, `pais_id`, `rut`, `nombre`, `paterno`, `materno`, `nacimiento`, `fono`, `mail`, `gerencia`, `antiguedad`, `civil`, `hijos`, `licencia`, `talla`, `direccion`, `contacto`, `afp`, `prevision`, `nivel`, `creacion`, `modificacion`) VALUES
(1, 8110, 46, '18.108.559-2', 'Ruben Eduardo', 'Tejeda', 'Roa', '1992-04-12', '+5691223304', 'rubentejedaroa@gmail.com', 'Santa Fe', 1, 'SOLTERO/A', 3, 'A2', 'M', 'calle seis #2682, concepción Hualpen.', '+569 numero', 'AFP Cuprum', 'FONASA', 'Profesional', '2017-03-09 18:54:02', '2017-03-29 21:15:51');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `trabajador_evaluador`
--

CREATE TABLE `trabajador_evaluador` (
  `id` smallint(5) UNSIGNED NOT NULL,
  `tra_id` int(10) UNSIGNED NOT NULL COMMENT 'Trabajador',
  `tipo` enum('N/A','PSICOLOGO','FUNCIONARIO','EVALUADOR PRACTICO') NOT NULL,
  `inicio` date NOT NULL COMMENT 'Fecha de inicio',
  `termino` date NOT NULL COMMENT 'Fecha de Termino',
  `creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de ingreso'
...
--
-- Volcado de datos para la tabla `trabajador_experiencia`
--

INSERT INTO `trabajador_experiencia` (`id`, `tra_id`, `esp_id`, `suc_id`, `inicio`, `termino`, `cargo`, `funciones`) VALUES
(1, 1, 1, 1, '2000-03-15', '2017-03-29', 'Mecanico Estrobero', 'Mantenía el área de ....');
...
('0NT3RmKKslmW8K9WbtzyyITCe8aXaZHc', NULL, 1490363511, 1, 1),
('1cYb2PWmRDLXJQxvgCIcdqFYxUEITU_4', NULL, 1489977708, 1, 1),
('1kFlEPbD6X8L6WOhbh7ImZ7Q86gpxkMi', NULL, 1489177821, 1, 1),
('1L4uNiloYm4ueXifL1_FeCr6dAXXmkHc', NULL, 1489977745, 1, 1),
('2Nd9xSXK4Bkf2g9Vikh1oq_U2DS9vqAB', NULL, 1489978801, 1, 1),
('5ZU1hmcsSVSM5O-Zrgs7dnYzFcYTfdm_', NULL, 1489978266, 1, 1),
('7tgnCdkYFuwgpq9Uh9bnAuLP5PiykEie', NULL, 1490370629, 1, 1),
('b_-_NA58gOYmGSo5Yer7p07fm7RlLQGv', NULL, 1489978002, 1, 1),
...
('ElPbZXdekQVM6hcglYTibNMlUu4CxFzH', NULL, 1489978147, 1, 1),
('hNgK-Xo_qKQCcFAgjVLHmjDh5re-O3ro', NULL, 1489977943, 1, 1),
('iXAtC90lU2wF2-BU3tiNtGiNEwAjKqV0', NULL, 1489977791, 1, 1),
('Lpf0TuX641Kjnf9jv8BZriZALfhh-w1r', NULL, 1489978017, 1, 1),
('MkYEwkllzdIs78bM7bzDDY7rokD7bbcb', NULL, 1489977407, 1, 1),
('mlsGuyUuzIe17Fbh5v6YXhzP5FqVqYdS', NULL, 1489977243, 1, 1),
('mO1Hmc8jP2PF_rUrZvhQC7Vwg0qR1HpP', NULL, 1489075107, 2, 1),
('POWLTwJmaRt68BdClhlBFEgx_EvtQ6c_', NULL, 1489074343, 2, 1),
('pqEF_GMRBCny42kSqyEvTiVwLTTIkViN', NULL, 1489977524, 1, 1),
('Q16pgTuvpnoHc5PK_ErFt3-lY3zsqZE-', NULL, 1489977118, 1, 1),
('Qw_oViKHfK1WKc0K2nKCRtGsNv4Xf7Ca', NULL, 1489978390, 1, 1),
('RFvt1VuL8W3eodGl0d_BhpLWSpNm9t13', NULL, 1489975362, 1, 1),
('rP0jVOWDjZ30M3ddjsnZw3B95x3jEU6T', NULL, 1489977624, 1, 1),
('RyJv1X_up8ov21raBlvREdutkHgWStAf', NULL, 1489977690, 1, 1),
('SekvYhCt2sHNRd1l-HvJfFDPP_zRV9S0', NULL, 1489975128, 1, 1),
('SPWLmgFeeQiRVH37-hII97VwzVfCN4vw', NULL, 1489977824, 1, 1),
('sYoG7BPnvIRmN_OkqYe-WtoVkaF9pwDV', NULL, 1489586878, 1, 1),
('tAnc5T-64DA6TmYTtnx-uss3ti4n9dRq', NULL, 1490370452, 1, 1),
('U77Mf5JU3OAbh7BebGseEn-oWBeNxxrD', NULL, 1588819394, 1, 1),
('UA1pKjPYhonhxPxfus3iiyuA6Ja8tDZ7', NULL, 1489978298, 1, 1),
('ULdJofBsbuLwbuS3CWFJB9975edW6PhA', NULL, 1489977905, 1, 1),
('VDHrdZJsaI9m-xTCcftvYS8eA0JmZLLw', NULL, 1489978357, 1, 1),
('vfkSufo6EWXXolSpFUq95SsER8-dMCRi', NULL, 1489977366, 1, 1),
('vkYQW918pUsKATJnbugSRWE3xrK4BHY7', 'iG1tAptcrYuDwIim8EXQa0flFFMJ_pIP', 1489179601, 2, 1),
('w6wd8qAhe2nBj9pZCRBqoV4PgdknsP2M', NULL, 1489977477, 1, 1),
('WL_omuSxugTSMvWhEmKcjbCXMZ3-pHAP', NULL, 1489977627, 1, 1),
('WWJ8boDUBzfiF46bMgPfBwxe1PXmBivV', NULL, 1489977743, 1, 1),
('yoOmQPbugK7RMva1Z1Sk44FB9T8I1FPj', NULL, 1489977613, 1, 1),
('zjn5pRj2YaLcIOvuUCVpNH0IA-xr8xgQ', 'BZqufhtI0IIWM_P3nNlOyFvlvLcWZm9R', 1489077564, 2, 1),
('ZsIOmcbhXcG03H8a4X0cNjB8cbF-YACd', NULL, 1489978232, 1, 1);
...
(29, 'Trabajador'),
(32, 'Unity'),
(34, 'v1_clasificacion_index'),
(35, 'v1_clasificacion_search'),
(36, 'v1_test_index'),
(24, 'v1_users_delete'),
...
ALTER TABLE `orden_trabajo_solicitud`
  ADD PRIMARY KEY (`id`),
  ADD KEY `emp_id` (`emp_id`),
  ADD KEY `orden_trabajo_solicitud_ibfk_2` (`usu_id`);
...
ALTER TABLE `trabajador`
  ...
  ADD UNIQUE KEY `rut` (`rut`),
  ADD KEY `com_id` (`com_id`),
  ADD KEY `trabajador_ibfk_2` (`pais_id`);

--
-- Indices de la tabla `trabajador_evaluador`
--
ALTER TABLE `trabajador_evaluador`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tra_id` (`tra_id`);
...
--
ALTER TABLE `especialidad`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Especialidad', AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `evaluacion_tipo`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Tipo de evaluación', AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `ficha_practica`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Nota de Ficha Practica';
--
...
--
ALTER TABLE `orden_trabajo`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Orden de Trabajo', AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT de la tabla `trabajador_evaluador`
--
ALTER TABLE `trabajador_evaluador`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `trabajador_experiencia`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Experiencia', AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `evaluacion_pregunta`
  ADD CONSTRAINT `evaluacion_pregunta_ibfk_1` FOREIGN KEY (`eva_id`) REFERENCES `evaluacion_teorica` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `evaluacion_teorica`
--
ALTER TABLE `evaluacion_teorica`
  ADD CONSTRAINT `evaluacion_teorica_ibfk_1` FOREIGN KEY (`tev_id`) REFERENCES `evaluacion_tipo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `ficha_respuesta`
  ADD CONSTRAINT `ficha_respuesta_ibfk_2` FOREIGN KEY (`alt_id`) REFERENCES `evaluacion_alternativa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ficha_respuesta_ibfk_3` FOREIGN KEY (`fict_id`) REFERENCES `ficha_teorico` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `orden_trabajo`
  ...
  ADD CONSTRAINT `orden_trabajo_ibfk_5` FOREIGN KEY (`per_id`) REFERENCES `perfil` (`id`);

--
-- Filtros para la tabla `orden_trabajo_solicitud`
--
ALTER TABLE `orden_trabajo_solicitud`
  ADD CONSTRAINT `orden_trabajo_solicitud_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `empresa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `orden_trabajo_solicitud_ibfk_2` FOREIGN KEY (`usu_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `trabajador`
  ADD CONSTRAINT `trabajador_ibfk_1` FOREIGN KEY (`com_id`) REFERENCES `comuna` (`com_id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `trabajador_ibfk_2` FOREIGN KEY (`pais_id`) REFERENCES `pais` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Filtros para la tabla `trabajador_evaluador`
--
ALTER TABLE `trabajador_evaluador`
  ADD CONSTRAINT `trabajador_evaluador_ibfk_1` FOREIGN KEY (`tra_id`) REFERENCES `trabajador` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
