...
class PerfilevaluacionteoricaController extends ActiveController
{
	public $modelClass = 'app\modules\v1\models\PerfilEvaluacionTeorica';
			...
			try {
				...
				$provider = new \yii\data\ActiveDataProvider([
					...
					'sort' => [
				  	...
				  	'pagination' => [
						'defaultPageSize' => 20,	public function actionSearch()
	{
		if (!empty($_GET)) {
			$request=\Yii::$app->request;
			$reserve=['page','index','order','limit'];
